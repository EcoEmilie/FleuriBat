...
#Site
data_site_sf = readRDS(file.path(FolderSite,"data_site.rds")) %>% 
  st_as_sf(coords = c("X","Y"), crs = 4326) %>% #au départ en WGS 84
  st_transform(2154) 

# Chargement des données 2021 ---------------------------------------------

data_RPG_2021_IDF = st_read(file.path(FolderDonnees,RPG2021,"IDF/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)

data_RPG_2021_CVL = st_read(file.path(FolderDonnees,RPG2021,"Centre_Val_de_Loire/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)

data_RPG_2021_N= st_read(file.path(FolderDonnees,RPG2021,"Normandie/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)

data_RPG_2021 = st_as_sf(rbind(data_RPG_2021_CVL,data_RPG_2021_IDF, data_RPG_2021_N))
...
saveRDS(data_RPG_2021_B,file.path(FolderDonnees,"donnees_RPG_2021.rds"))

# Chargement données RPG 2020 --------------------------------------------------

data_RPG_2020_IDF = st_read(file.path(FolderDonnees,RPG2020,"Ile_de_France/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)

data_RPG_2020_CVL = st_read(file.path(FolderDonnees,RPG2020,"Centre_Val_de_Loire/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)

data_RPG_2020_N= st_read(file.path(FolderDonnees,RPG2020,"Normandie/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)
...
saveRDS(data_RPG_2020_B,file.path(FolderDonnees,"donnees_RPG_2020.rds"))

# Chargement données RPG 2019 --------------------------------------------------

data_RPG_2019_IDF = st_read(file.path(FolderDonnees,RPG2019,"IDF/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)

data_RPG_2019_CVL = st_read(file.path(FolderDonnees,RPG2019,"Centre_Val_de_Loire/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)

data_RPG_2019_N= st_read(file.path(FolderDonnees,RPG2019,"Normandie/PARCELLES_GRAPHIQUES.shp")) %>% 
  st_transform(2154)
...
saveRDS(data_RPG_2019_B,file.path(FolderDonnees,"donnees_RPG_2019.rds"))
