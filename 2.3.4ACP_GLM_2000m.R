...
resultat_acp_2000_A$Dim.1 # area_prairie, area_praiperm  
...
Mod = glmmTMB(sum_contact ~ Num_passag + Modalite_protocole + SDC + area_prairie + nb_parcelle + Shannon_cultu +
                (1| year/Commune),
              data = data_mod,
...
Mod = lmer(Richesse_spe ~ Num_passag + Modalite_protocole + SDC + area_prairie + nb_parcelle + Shannon_cultu +
                (1| year/Commune),
              data = data_mod_spe) 
